...
export default function ShipPage() {
  ...
  useEffect(() => {
    const timer = setTimeout(async () => {
      ...
      try {
        ...
        if (postalCodeInput.trim()) params.set("postalCode", postalCodeInput.trim());
  ...
  async function handleShowPickupPoints() {
    if (!formData.recipientPostalCode) return;
        ...
        consignments: [
          {
            ...
            parties: {
              ...
              pickupPoint: formData.deliveryMethod === "pib" ? null : undefined,
            },
            product: {
        ...
        <div className="w-full">
          ...
          <form onSubmit={handleSubmit} className="space-y-10">
            <section className="space-y-6">
              ...
              <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                <div className="space-y-2">
                  <label htmlFor="recipientName" className="block text-sm font-medium text-black dark:text-zinc-50">
                    Navn
                  </label>
                  <input
                    id="recipientName"
                ...
                <div className="space-y-2">
                  <label htmlFor="recipientPostalCode" className="block text-sm font-medium text-black dark:text-zinc-50">
                    Postnummer
                  </label>
                  <input
                ...
                <div className="space-y-2">
                  <label htmlFor="recipientCity" className="block text-sm font-medium text-black dark:text-zinc-50">
                    Sted
                  </label>
                  <input
                    id="recipientCity"
                ...
                <div className="space-y-2">
                  <label htmlFor="recipientEmail" className="block text-sm font-medium text-black dark:text-zinc-50">
                    E-post
                  </label>
                  <input
                    id="recipientEmail"
                ...
                <div className="space-y-2">
                  <label htmlFor="recipientPhone" className="block text-sm font-medium text-black dark:text-zinc-50">
                    Telefonnummer
                  </label>
                  <input
                    id="recipientPhone"
                ...
                {deliveryMethods.map((method) => {
                  ...
                  return (
                    <button
                      ...
                      type="button"
                      onClick={() => {
                        setFormData((prev) => ({ ...prev, deliveryMethod: method.id }));
                        setShowPickupPoints(false);
                      }}
            ...
            <button
              ...
              className="w-full rounded-2xl border border-black/10 bg-white px-6 py-4 text-left text-sm text-zinc-600 transition-colors hover:border-black/20 disabled:opacity-40 dark:border-white/10 dark:bg-black dark:text-zinc-400 dark:hover:border-white/20"
            >
            ...
            {showPickupPoints && pickupPoints.length > 0 && (
              <div className="space-y-3">
                {pickupPoints.slice(0, 5).map((pp) => (
                  <div
                    key={pp.id}
                    className="flex items-center justify-between rounded-2xl border border-black/10 bg-white p-4 dark:border-white/10 dark:bg-black"
                  >
                    <div>
